...
//       <div class="whatsapp-chat-box" [class.active]="isChatOpen">
//         <div class="chat-header">
//           <div class="chat-header-content">
//             <div class="chat-logo">{{ logoText }}</div>
//             <div class="chat-info">
//               <h3>{{ businessName }}</h3>
...
//     </div>
//   `,
//   styleUrls: ['./Contact/contact.css']
// })
// export class WhatsappWidgetComponent {
//   @Input() whatsappNumber = '919876543210';
//   @Input() businessName = 'BedR';
//   @Input() logoText = 'B';
//   @Input() welcomeMessage = 'Need a PG or hostel? Let\'s find it together! 🏠';
//   @Input() status = 'Online';
